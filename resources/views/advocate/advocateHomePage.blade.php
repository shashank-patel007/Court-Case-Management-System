...
<nav class="navbar navbar-height">
  ...
  <ul class="navbar-nav">
		<li class="user-content" >
			<a href="{{ route('advocateAnnouncements') }}"  target="client-content">
...
<div class="content">
	<iframe src="{{ route('advocateAnnouncements') }}" class="content-container" frameborder="0" name="client-content">
